...
struct symbol *push(struct symbol *top,char _simbolo[], char _categoria[], int _escopo, int _pr_var_simples, int _pr_param_formal, char _pr_procedimento[], char _tipo_normal[], char _tipo_procedimento[], int _numero_parametros, int _tipo_chamada){
